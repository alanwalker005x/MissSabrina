    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("Heya:) My Master Joined The Group! Feeling Great To See You [Master](https://t.me/Unknown_Hacker_X) .")
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text("My Master Left , Feeling Bad. Miss You Master!")
                return
